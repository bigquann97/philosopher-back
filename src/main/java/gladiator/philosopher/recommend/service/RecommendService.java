...
public interface RecommendService {
  ...
  void createRecommendPost(
      final Post post,
      final Account account);

  void deleteRecommendPost(
      final Post post,
      final Account account);

  void createRecommendThread(
      final Thread thread,
      final Account account);

  void deleteRecommendThread(
      final Thread thread,
      final Account account);

  void createRecommendComment(
      final Comment comment,
      final Account account);

  void deleteRecommendComment(
      final Comment comment,
      final Account account);
